...
DATASETS = {
    "MedQA-CN": "../../data/test_data/medqa_cn_test.jsonl",
    "MedQA-EN": "../../data/test_data/medqa_en_test.jsonl"
}
...
def main():
    ...
    with open(os.path.join(os.path.dirname(__file__), "../../outputs/eval_results.json"), "w", encoding="utf-8") as f:
    ...
    fig.tight_layout()
    plt.savefig(os.path.join(os.path.dirname(__file__), "../../outputs/medqa_eval_comparison.png"))
