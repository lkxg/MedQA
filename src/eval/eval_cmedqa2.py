...
# cMedQA2 测试集
CMEDQA2_DATASET = "../../data/test_data/cmedqa2_test.jsonl"
...
def main():
    ...
    with open(os.path.join(os.path.dirname(__file__), "../../outputs/eval_results_cmedqa.json"), "w", encoding="utf-8") as f:
    ...
    fig.tight_layout()
    plt.savefig(os.path.join(os.path.dirname(__file__), "../../outputs/cmedqa_eval_comparison.png"))
